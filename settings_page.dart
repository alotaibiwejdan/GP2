...
class _SettingsPageState extends State<SettingsPage> {
  ...
  // Data from Version 1 (Firebase)
  late String userName;
  late String userEmail;
  User? currentUser;

  // Data from Version 2 (Avatar Picker)
  ...
  // --- New Feature: Avatar Picker (from Version 2) ---
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              // Option: Update Firebase Display Name
  ...
  // ... (Other Dialogs: Password, Notifications, Help remain the same)
  void _showChangePasswordDialog() { /* Same as Version 1 */ }
  void _showNotificationsDialog() { /* Same as Version 1 */ }
  ...
  void _showLanguageDialog() {
    showModalBottomSheet(context: context, shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))), builder: (context) => Column(mainAxisSize: MainAxisSize.min, children: [
      const Padding(padding: EdgeInsets.all(15.0), child: Text("اختر اللغة", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16))),
  ...
  void _showHelpCenter() { /* Same as Version 1 */ }
  void _showAboutMersal() { /* Same as Version 1 */ }
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  // Clickable Avatar from Version 2
                  GestureDetector(
  ...
  // Helper methods (Keep these from Version 1 for consistency)
  Widget _buildSectionHeader(String title) {
    return Container(width: double.infinity, padding: const EdgeInsets.only(bottom: 10), child: Text(title, textAlign: TextAlign.right, style: const TextStyle(color: Colors.grey, fontWeight: FontWeight.bold)));
  }

  Widget _buildSettingsBox(List<Widget> children, Color cardColor) {
    return Container(margin: const EdgeInsets.only(bottom: 20), decoration: BoxDecoration(color: cardColor, borderRadius: BorderRadius.circular(15), border: Border.all(color: Colors.grey.withOpacity(0.1))), child: Column(children: children));
  }
