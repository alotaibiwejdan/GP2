            ...
            children: [
              ...
              _buildSettingsBox([
                ...
                _buildListTile(Icons.info_outline, 'عن مرسال', () {
                  showDialog(context: context, builder: (context) => Directionality(textDirection: TextDirection.rtl, child: AlertDialog(title: const Text('عن مرسال'), content: const Text('تطبيق مرسال هو تطبيق ذكي يساعد على تنظيم الاجتماعات و تتبع وصول المشاركين و معرفة وقت الوصول المتوقع باستخدام الموقع و التنبيهات الذكيه لتحسين التنسيق بين المستخدمين'), actions: [TextButton(onPressed: () => Navigator.pop(context), child: const Text('شكراً'))])));
                }, textColor)
              ], cardColor),
